...
public class Session {
	...
	private TimeUpdater timeUpdater; // Thread qui met à jour le temps de la
										// session toutes les 5 secondes.
	...
	private ArrayList<PasswordTry> passwordTries; // liste des essais de mot de
													// passe ayant eu lieu
													// durant le tamps de la
													// session
	...
	public Session(SessionManager manager) {
		...
		shceduledEnd = new Date(debutTime.getTime() + 60 * 1000); // fin de la
																	// session
																	// prévue 10
																	// min après
																	// le début
	...
	// ajoute un essai de mot de passe et termine la session si l'essai est un
	// succes
